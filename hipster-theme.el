...
;;;;; proofgeneral
   ...
   `(proof-tacticals-name-face ((t (:inherit font-lock-constant-face :foreground nil :background 
,hipster-bg))))
   `(proof-tactics-name-face ((t (:inherit font-lock-constant-face :foreground nil :background 
,hipster-bg))))
...
;;;;; smartparens
   `(sp-show-pair-mismatch-face ((t (:foreground ,hipster-red+1 :background ,hipster-bg+3 :weight 
bold))))
